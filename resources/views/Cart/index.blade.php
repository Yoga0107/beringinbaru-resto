    ...
    <div class="small-container cart-page mb-4">
                     ...
                     <tr>
                        <td>
                            <div class="cart-info">
                                ...
                                <div>
                                    <p>{{$item->name}}</p>
                                    <small>Price : {{$item->price}} Rp</small>
                                </br>
                        ...
                        <td class="price">{{$item->quantity * $item->price }} Rp</td>
        ...
        @if (Cart::getSubTotal()>0)
            ...
            <table>
                <tr>
                    <td>SubTotal</td>
                    <td class="fw-bolder">{{Cart::getSubTotal() }} Rp</td>
                </tr>
                 <tr>
                    <td  colspan="2">
                        @if (Cart::getSubTotal()>0)
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <a href="#" class=" btn-paypal mt-3 ml-2 d-flex align-items-center "  >
